...
public class DIYSystem {
	...
	private boolean requestAttendant = false;
	private boolean memberinDB = false;
	...
	/**
	 * @author Saja Abufarha
	 * Gets error message to signals the Customer I/O regarding the weight ancy. 
